...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.tab4 = StepByStep_K_Means()
        self.tab5 = Survival_Curve()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.addTab(self.Stepbystep_cox, "Traditional model with Cox|")
        stylesheet = """ 
                    QTabBar::tab:selected {background: gray;}
                    QTabBar::tab{ background-color: #37474F } 
                    QTabBar::tab{ color: white }
        ...
        ##K_means TabWidget ##
        #############################
        self.K_Means = self.tab4.setupStep_by_step_K_Means()
        ...
        #############################
        self.Survival_curve = self.tab5.setupSurvival_curve()
    ...
    def output_box(self):
        if self.tabWidget.currentIndex() == 0:
            ...
            sys.stdout = k_means_Thread.port(self.tab4.Result_survival)
        elif self.tabWidget.currentIndex() == 4:
            sys.stdout = Survival_Curve_thread.port(self.tab5.Result_text)
